...
/**
 * Main Mapillary Image Viewer dialog
 * @author Polyglot
 *
 */
...
public final class MapillaryImageViewerDialog extends ImageViewerDialog {
...
/*    private static final String COMMAND_ZOOM = "zoom";
    ...
    private static MapillaryImageViewerDialog dialog;

    private boolean collapseButtonClicked = false;

    static void newInstance() {
        dialog = new MapillaryImageViewerDialog();
    } */
     ...
     */
/*     public static MapillaryImageViewerDialog getInstance() {
        if (dialog == null)
...
/*     private JButton btnNext;
    ...
    /* private MapillaryImageViewerDialog() {
        super(tr("Geotagged Mapillary Images"), "geoimage", tr("Display geotagged Mapillary images"), Shortcut.registerShortcut("tools:geotagged",
        tr("Tool: {0}", tr("Display geotagged Mapillary images")), KeyEvent.VK_M, Shortcut.DIRECT), 200);
